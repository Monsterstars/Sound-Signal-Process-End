...
public class SearchOneFeature {
    ...
    //提供给主函数调用的方法
    public static String[] doSearchOneFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH, String groupId, String featureId) {
        ...
        try {
            ...
            System.out.println("!!!!!!!!!!!!!!!!!!!!!1text字段Base64解码后=>"+jsonObject);
            String groupIdeee = "Xxxx";
            String featureIdeee = "xxxxx";
            return new String[]{groupIdeee, featureIdeee};
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
