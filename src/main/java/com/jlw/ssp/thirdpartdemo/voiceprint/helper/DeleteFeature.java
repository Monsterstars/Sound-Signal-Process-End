package com.jlw.ssp.thirdpartdemo.voiceprint.helper;
...
public class DeleteFeature {
    ...
    public DeleteFeature(String groupId, String featureId, String requestUrl, String APPID, String apiSecret, String apiKey) {
    ...
    //提供给主函数调用的方法
    public static void doDeleteFeature(String requestUrl,String APPID,String apiSecret,String apiKey, String groupId, String featureId) {
        DeleteFeature deleteFeature = new DeleteFeature(requestUrl, APPID, apiSecret, apiKey, groupId, featureId);
        try {
    ...
    public String doRequest() throws Exception {
        ...
        String params = buildParam(groupId, featureId);
     ...
     * @return 参数字符串
     */
    private String  buildParam(String groupId, String featureId) throws IOException {
        String param = "{"+
                "    \"header\": {"+
                "        \"app_id\": \""+APPID+"\","+
                "        \"status\": 3"+
